...
The canonical compatibility/support policy lives in the framework repo:
<https://github.com/pylar-foundation/pylar-framework/blob/main/docs/site/support-policy.md>.
